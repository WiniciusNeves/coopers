      ...
      <div id="cards-container" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mt-[-20px] px-4">
          ...
          if (isset($good_things_section['good_things_cards']) && is_array($good_things_section['good_things_cards'])) :
              foreach ($good_things_section['good_things_cards'] as $index => $card) :
                  ...
                  $read_more_url = !empty($card['read_more_url']) ? $card['read_more_url'] : '#';
                  ?>
                  <div class="good-thing-card flex-shrink-0 bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden <?php echo $index >= 3 ? 'hidden' : ''; ?>">
                      ...
                      <div class="p-4 text-left">
                          ...
                          <p class="text-base font-semibold text-gray-800 mb-4">
                              <?php echo nl2br(esc_html($card_text)); ?>
                          </p>
                          
                          <a href="<?php echo esc_url($read_more_url); ?>" class="text-[#56c870] underline text-sm hover:no-underline transition duration-300">
    ...
    <div class="relative flex flex-col items-center max-w-2xl mx-auto bg-white rounded-lg shadow-lg p-8 pt-20 pb-10">
        ...
        <div class="mt-8 flex flex-col items-start w-full">
            ...
            <form id="contact-form" class="flex flex-col gap-4 w-full" method="POST">
                ...
                <button class="bg-[#56c870] text-white py-3 px-4 border-none rounded-md font-semibold hover:bg-green-600 transition duration-300 shadow-md">
